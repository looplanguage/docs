...
function LightningIcon() {
  return (
    <svg style={{ maxHeight: 130 }} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
function LightbulbIcon() {
  return (
    <svg style={{ maxHeight: 130 }} xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
